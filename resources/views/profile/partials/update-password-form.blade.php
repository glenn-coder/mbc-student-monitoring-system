<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div x-data="{ password: '', showPassword: false, confirmPassword: '', showConfirmPassword: false }" class="space-y-6">
            <div>
            ...
            <div>
                ...
                <div class="relative mt-1">
                    <x-text-input id="update_password_password_confirmation" name="password_confirmation" x-bind:type="showConfirmPassword ? 'text' : 'password'" class="block w-full pr-10" autocomplete="new-password" x-model="confirmPassword" />
