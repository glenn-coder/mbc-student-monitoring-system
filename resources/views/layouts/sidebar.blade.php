...
<div :class="sidebarExpanded ? 'w-64 translate-x-0' : '-translate-x-full md:w-20 md:translate-x-0'" class="sidebar-scrollbar fixed md:static inset-y-0 left-0 z-[60] flex flex-col h-screen px-4 py-8 overflow-y-auto bg-mbc-navy border-r border-white/10 transition-all duration-300 flex-shrink-0">
    ...
    <div class="flex flex-col justify-between flex-1 mt-2">
        <nav class="space-y-2 text-sm">
            ...
            <a class="flex items-center py-3 transition-colors rounded-xl {{ request()->routeIs('admin.students.*') ? 'text-white bg-[#2F2FE4]' : 'text-slate-400 hover:text-white hover:bg-white/5' }}" :class="sidebarExpanded ? 'px-4' : 'justify-center px-0'" href="{{ route('admin.students.index') }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a class="flex items-center py-3 transition-colors rounded-xl {{ request()->routeIs('admin.instructors.*') ? 'text-white bg-[#2F2FE4]' : 'text-slate-400 hover:text-white hover:bg-white/5' }}" :class="sidebarExpanded ? 'px-4' : 'justify-center px-0'" href="{{ route('admin.instructors.index') }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a class="flex items-center py-3 transition-colors rounded-xl {{ request()->routeIs('admin.assignments.*') ? 'text-white bg-[#2F2FE4]' : 'text-slate-400 hover:text-white hover:bg-white/5' }}" :class="sidebarExpanded ? 'px-4' : 'justify-center px-0'" href="{{ route('admin.assignments.index') }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a class="flex items-center py-3 transition-colors rounded-xl {{ request()->routeIs('admin.timetable.*') ? 'text-white bg-[#2F2FE4]' : 'text-slate-400 hover:text-white hover:bg-white/5' }}" :class="sidebarExpanded ? 'px-4' : 'justify-center px-0'" href="{{ route('admin.timetable.index') }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                <span class="mx-4 font-medium whitespace-nowrap" x-show="sidebarExpanded">Timetable</span>
            </a>

            <a class="flex items-center py-3 transition-colors rounded-xl {{ request()->routeIs('admin.subjects.*') ? 'text-white bg-[#2F2FE4]' : 'text-slate-400 hover:text-white hover:bg-white/5' }}" :class="sidebarExpanded ? 'px-4' : 'justify-center px-0'" href="{{ route('admin.subjects.index') }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a class="flex items-center py-3 transition-colors rounded-xl {{ request()->routeIs('admin.courses.*') ? 'text-white bg-[#2F2FE4]' : 'text-slate-400 hover:text-white hover:bg-white/5' }}" :class="sidebarExpanded ? 'px-4' : 'justify-center px-0'" href="{{ route('admin.courses.index') }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                </svg>
                <span class="mx-4 font-medium whitespace-nowrap" x-show="sidebarExpanded">Course</span>
            </a>

            <a class="flex items-center py-3 transition-colors rounded-xl {{ request()->routeIs('admin.admins.*') ? 'text-white bg-[#2F2FE4]' : 'text-slate-400 hover:text-white hover:bg-white/5' }}" :class="sidebarExpanded ? 'px-4' : 'justify-center px-0'" href="{{ route('admin.admins.index') }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a class="flex items-center py-3 transition-colors rounded-xl {{ request()->routeIs('admin.audit-logs.*') ? 'text-white bg-[#2F2FE4]' : 'text-slate-400 hover:text-white hover:bg-white/5' }}" :class="sidebarExpanded ? 'px-4' : 'justify-center px-0'" href="{{ route('admin.audit-logs.index') }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a class="flex items-center py-3 mt-1 transition-colors rounded-xl {{ request()->routeIs('student.schedule') ? 'text-white bg-[#2F2FE4]' : 'text-slate-400 hover:text-white hover:bg-white/5' }}" :class="sidebarExpanded ? 'px-4' : 'justify-center px-0'" href="{{ route('student.schedule') }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                <span class="mx-4 font-medium whitespace-nowrap" x-show="sidebarExpanded">Class Schedule</span>
            </a>
            @endif
        </nav>
    </div>
