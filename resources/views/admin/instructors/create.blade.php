            ...
            <form action="{{ route('admin.instructors.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="full_name" id="full_name" value="{{ old('full_name') }}" autocomplete="off" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" required>
                        @error('full_name')
                    ...
                    <div>
                        ...
                        <input type="text" name="instructor_number" id="instructor_number" value="{{ old('instructor_number') }}" autocomplete="off" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="major_specialization" id="major_specialization" value="{{ old('major_specialization') }}" autocomplete="off" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="course" id="course" value="{{ old('course') }}" autocomplete="off" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" required>
                        @error('course')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
