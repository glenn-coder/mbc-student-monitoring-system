<x-app-layout>
    <div class="p-8 mx-auto max-w-3xl">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('admin.admins.index') }}" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-md hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 flex items-center gap-2">
            ...
            <form action="{{ route('admin.admins.update', $admin) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div x-data="{ password: '', showPassword: false }" class="md:col-span-2">
                        <label for="password" class="block text-sm font-bold text-gray-700">Password <span class="text-xs font-normal text-gray-500">(Leave blank to keep current password)</span></label>
                        ...
                        <div x-show="password.length > 0" style="display: none;" class="mt-3 text-sm space-y-1">
