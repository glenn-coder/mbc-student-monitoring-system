        ...
        <form action="{{ route('admin.assignments.store-students', $assignment) }}" method="POST">
            ...
            <div class="mb-6" x-data="{ 
                ...
                <div class="flex items-center justify-between mb-4 relative">
                    ...
                    <div>
                        <button type="button" @click="showFilters = !showFilters" class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm">
                    ...
                    <div class="space-y-2">
                        @foreach($students as $student)
                            <div class="flex items-center" 
                                 x-show="(!appliedCourse || '{{ strtolower($student->course->code ?? '') }}'.includes(appliedCourse.toLowerCase())) && (!appliedYear || '{{ strtolower($student->year) }}'.includes(appliedYear.toLowerCase()))">
