            ...
            <form action="{{ route('admin.students.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="middle_name" id="middle_name" value="{{ old('middle_name') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        @error('middle_name')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="mt-6">
                    <div class="flex items-start gap-3 rounded-lg border border-blue-200 bg-blue-50 px-4 py-3">
                        ...
                        <div>
                            <p class="text-sm font-medium text-blue-800">Password Auto-Generated</p>
                            <p class="mt-0.5 text-sm text-blue-700">
                                The student's initial password will be automatically set to:
                                <span class="font-mono font-semibold">&lt;Course Code&gt;-&lt;Student Number&gt;</span>
                                <br>
                                <span class="text-xs text-blue-600">e.g. <span class="font-mono">BSIT-00001</span></span>
                                <br class="mt-1">
                                The student can change this password anytime from their profile after logging in.
                            </p>
                        </div>
                    </div>
                </div>
